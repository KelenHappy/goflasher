...
var catalogs = map[Locale]map[string]string{
	English: {
		...
		"stage.writing": "Writing", "stage.flushing": "Synchronizing device", "stage.verifying": "Verifying", "stage.ejecting": "Safely ejecting",
		"metrics.progress": "Average speed: %.1f MiB/s        Processed: %.1f MiB        Remaining: %s", "metrics.finalizing": "Speed: —        Finalizing device…",
	...
	TraditionalChinese: {
		...
		"stage.writing": "正在寫入", "stage.flushing": "正在同步裝置", "stage.verifying": "正在驗證", "stage.ejecting": "正在安全退出",
		"metrics.progress": "平均速度：%.1f MiB/s        已處理：%.1f MiB        剩餘：%s", "metrics.finalizing": "速度：—        正在完成裝置作業…",

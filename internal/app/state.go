...
var transitions = map[State]map[State]bool{
	...
	Planning:            {Unmounting: true, Cancelled: true, Failed: true},
	Unmounting:          {Writing: true, StagingWIM: true, Partitioning: true, Cancelled: true, Failed: true},
	StagingWIM:          {SplittingWIM: true, Partitioning: true, Cancelled: true, Failed: true},
	SplittingWIM:        {Partitioning: true, Cancelled: true, Failed: true},
